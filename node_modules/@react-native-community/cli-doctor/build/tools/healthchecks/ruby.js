...
var _default = {
  ...
  getDiagnostics: async ({
    ...
    switch (code) {
      ...
      case output.NO_GEMFILE:
        fallbackResult.description = `Could not find the project ${_picocolors().default.bold('Gemfile')} in your project folder (${_picocolors().default.dim(projectRoot)}), guessed using my built-in version.`;
        break;
      default:
        if (versionOrError) {
  ...
  runAutomaticFix: async ({
    ...
    logManualInstallation({
      healthcheck: 'Ruby',
      url: _cliTools().link.docs('set-up-your-environment', 'ios', {
        hash: 'ruby',
        guide: 'native'
      })
    });
