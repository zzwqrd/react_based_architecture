...
function printNewRelease(name, latestRelease, currentVersion) {
  ...
  _logger.default.info(`Changelog: ${_picocolors().default.dim(_picocolors().default.underline(latestRelease.changelogUrl))}`);
  _logger.default.info(`Diff: ${_picocolors().default.dim(_picocolors().default.underline(latestRelease.diffUrl))}`);
  _logger.default.info(`For more info, check out "${_picocolors().default.dim(_picocolors().default.underline(link.docs('upgrading', 'none')))}".`);
